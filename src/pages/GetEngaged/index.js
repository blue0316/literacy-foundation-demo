  ...
  return (
    <main>
      ...
      >
          ...
          <div className="container">
            <div className="md:grid md:grid-cols-2 md:gap-12">
              ...
              <div className="flex flex-col justify-center">
                <p className="mb-6 text-xl text-supportive leading-tight md:leading-normal">
        ...
        <div className="flex flex-col justify-center items-center h-screen px-10 lg:px-40 pb-16">
          <p className="text-xl sm:text-2xl lg:text-3xl font-secondary text-supportive mb-4 md:mb-16 md:leading-tight">
            ...
            >
              <SwiperSlide>
                <div className="group flex flex-col justify-start shadow-box">
                  <div className="flex relative justify-center mb-2 md:mb-6">
                    <img
                  ...
                  <h3 className="text-xl md:text-2xl mb-2 px-2 md:px-4 text-nowrap text-ellipsis overflow-hidden">
                    Education for All Ages
                  </h3>
                  <p className="text-lg md:text-xl text-supportive leading-tight md:leading-snug px-2 md:px-4 pb-4 md:pb-6">
              ...
              <SwiperSlide>
                <div className="group flex flex-col justify-start shadow-box">
                  ...
                  <p className="text-lg md:text-xl text-supportive leading-tight md:leading-snug px-2 md:px-4 pb-4 md:pb-6">
                    ...
                    marketing, or community engagement, volunteering with us is
                    an opportunity to hone your skills and gain valuable
                    experience.
                  </p>
                </div>
              </SwiperSlide>
        ...
        <div className="flex flex-col justify-center items-center h-screen px-4 sm:px-10 lg:px-40 pb-16">
          <p className="text-xl sm:text-2xl lg:text-3xl font-secondary text-supportive mb-4 md:mb-16 leading-none md:leading-tight">
          ...
          <div className="container">
            <div className="hidden 2xl:grid border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:grid-cols-3 bg-white mb-6">
            ...
            <div className="block 2xl:hidden mb-8">
              ...
              >
                <SwiperSlide className="h-full">
                  <figure className="group relative flex flex-col items-center justify-center h-full px-4 py-6 text-center transition-all duration-300 bg-primary">
                    <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">
                      Content Creators
                    </h3>
                    <div
                      ...
                      <div className="relative preserve-3d group-hover:my-rotate-y-180 w-full h-full duration-1000">
                        <div className="w-full h-full">
                          <blockquote className="max-w-2xl mx-auto text-gray-500 mb-2 dark:text-gray-400">
                            ...
                            <p>
                              Develop engaging and accessible educational
                              content, including videos, articles, and
                              infographics, to promote financial literacy.
                            </p>
                          </blockquote>
                        </div>
                ...
                <SwiperSlide className="h-full">
                  <figure className="group relative flex flex-col items-center justify-center h-full px-4 py-6 text-center transition-all duration-300 bg-primary">
                    ...
                    <div
                      ...
                      style={{ height: "calc(100% - 32px)" }}
                    >
                      <div className="relative preserve-3d w-full h-full duration-1000">
                        <div className="w-full h-full">
                          <blockquote className="max-w-2xl mx-auto text-gray-500 mb-2 dark:text-gray-400">
                            <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                              What you will do?
                            ...
                            <p>
                              ...
                              interactive websites and platforms for
                              disseminating financial education materials.
                            </p>
                          </blockquote>
                        </div>
                        <div className="w-full h-full overflow-hidden">
                      ...
                      <div className="relative preserve-3d w-full h-full duration-1000">
                        <div className="w-full h-full">
                          <blockquote className="max-w-2xl mx-auto text-gray-500 mb-2 dark:text-gray-400">
                            ...
                            <p>
                              Organize workshops, seminars, and local events to
                              provide in-person financial education and engage
                              with students and adults in your community.
                            </p>
                          </blockquote>
                        </div>
                        <div className="w-full h-full overflow-hidden">
                      ...
                      <div className="relative preserve-3d w-full h-full duration-1000">
                        <div className="w-full h-full">
                          <blockquote className="max-w-2xl mx-auto text-gray-500 mb-2 dark:text-gray-400">
                            ...
                            <p>
                              Provide one-on-one or group financial coaching and
                              mentoring sessions to individuals seeking guidance
                              and support.
                            </p>
                          </blockquote>
                        </div>
                      ...
                      <div className="relative preserve-3d w-full h-full duration-1000">
                        <div className="w-full h-full">
                          <blockquote className="max-w-2xl mx-auto text-gray-500 mb-2 dark:text-gray-400">
                            ...
                            <p>
                              Engage with students and young adults to inspire
                              an early interest in financial literacy and help
