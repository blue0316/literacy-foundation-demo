...
const TermsOfServicePage = () => {
  return (
    <main>
      <div className="flex justify-center items-center h-screen pt-12 px-4 md:px-0 pb-28 xs:pb-20 md:pb-16">
        ...
        <div className="w-full h-full overflow-y-scroll md:container text-left">
